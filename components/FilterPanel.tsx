...
interface FilterPanelProps {
    ...
    statusFilter: 'all' | 'done' | 'not-done' | 'ignored';
    onStatusFilterChange: (status: 'all' | 'done' | 'not-done' | 'ignored') => void;
            ...
            <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
                ...
                <div className="md:col-span-3">
                    ...
                    <input 
                        ...
                        placeholder="Search advice or details..."
                    />
                </div>
                ...
                <div>
                    ...
                    <div className="space-y-2">
                        {['all', 'done', 'not-done', 'ignored'].map(status => (
                            <div key={status} className="flex items-center">
                                <input
                                    ...
                                    onChange={() => onStatusFilterChange(status as any)}
